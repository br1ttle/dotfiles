...
nnoremap <Leader>P :AsyncRun -mode=term echo '%' \| rev \| cut -c4- \| rev \| xargs -I{} zsh -c "pandoc '%' -t beamer -o {}.pdf --verbose -H '$HOME/Google Drive/2. - code/213. - latex/deeplists.tex' && open {}.pdf"<CR>
